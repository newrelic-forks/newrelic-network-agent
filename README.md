...
```Usage of ./bin/ktranslate:
  ...
  -format_metric string
    	Format to convert metrics to: (json|avro|netflow|influx|prometheus|new_relic|new_relic_metric|splunk|elasticsearch|kflow|parquet)
  ...
  -service_name string
    	Service identifier
  -sinks string
    	List of sinks to send data to. Options: (stdout|new_relic|new_relic_multi|otel|http) (default "stdout")
  -snmp string
